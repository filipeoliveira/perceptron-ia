...
df.columns = ["PetalLength","PetalWidth","SepalLength","Sepalwidth", "Class"]#adicionei header no arquivo para ficar mais facil a manipulacao

#2. setting X and target goal
mapping = {'Iris-setosa': 0, 'Iris-versicolor': 1, 'Iris-virginica': 2} #fazendo as classes serem um vetor
...
#trocando as classes para int =>
#Iris-setosa == 0 ; Iris-versicolor == 1 ; Iris-virginica == 2;
print(y)

#3. Adding randomness.
X_treino, X_teste, y_treino, y_teste = train_test_split(X, y, test_size=0.20, random_state=18) #usando 20% para teste
